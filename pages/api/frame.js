...
export default function handler(req, res) {
  ...
  if (message) {
    const imageUrl = `https://roastpraise.vercel.app/api/og?text=${encodedMessage}`;
    const tipLink = `https://warpcast.com/~/tip/498765`; // 👈 Tip langsung ke d2kind.eth
    ...
    const homeImageUrl = "https://roastpraise.vercel.app/api/og?text=Roast%20or%20Praise%3F&mode=home";
    res.status(200).json({
      version: "vNext",
      image: homeImageUrl,
      buttons: [
